        ...
        <div class="event-wrapper">
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<h3 class='event-name'><strong>Quiz ID : </strong> " . $row["qno"] . "</h3>";
                    echo "<p class='event-description'><strong>Quiz : </strong> " . $row["quiz"] . "</p>";
                    
                    echo "<div class='button-container'>";

                    echo "<a href='updatequiz.php?id=" . $row["id"] . "' class='update-btn'>Update</a>";
                    echo "<a href='deleteq.php?id=" . $row["id"] . "' class='delete-btn'>Delete</a>";
                    echo "</div>";
                    echo "</div>";
                }
            } else {
